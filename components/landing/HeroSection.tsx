  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-8 pt-28 pb-24 max-w-6xl">
        ...
        {/* CTAs */}
        <div className="hero-fade-4 flex items-center gap-4 flex-wrap">
          <Link
            href="/login"
      ...
      {/* Scroll indicator */}
      <div className="hero-fade-5 absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3">
