        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
          {features.map((feature, index) => (
            <div key={index} className="group relative">
              <Card className="relative overflow-hidden border border-slate-700/50 bg-slate-900/60 backdrop-blur-sm group-hover:scale-[1.02] transition-all duration-300 shadow-lg hover:border-emerald-500/30">
