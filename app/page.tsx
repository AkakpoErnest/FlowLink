...
export default function LandingPage() {
  const features = [
    ...
    },
    {
      ...
      description: "Issue and settle crypto invoices directly from AI agents on HashKey Chain",
      color: "text-blue-400",
    ...
    },
    {
      icon: Layers,
      title: "HashKey Chain",
      description: "Native integration with HashKey Chain — compliance-ready regulated blockchain",
        ...
        <div className="container mx-auto px-4 pt-32 pb-20 text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="space-y-4">
              ...
              {/* Headline with word hover animations */}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 shadow-lg shadow-emerald-900/40">
                <Link href="/login">
                  Get Started Free
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
            {features.map((feature, index) => (
              <div key={index} className="group relative">
                <Card className="relative overflow-hidden border bg-card group-hover:scale-[1.02] transition-all duration-300 shadow-lg hover:border-emerald-500/30">
                  <CardContent className="p-6 relative z-10">
                    <div className="flex items-start gap-4">
                      <div className={`p-3 rounded-xl ${feature.bgColor} shrink-0 group-hover:scale-110 transition-all duration-300`}>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {'badge' in feature && feature.badge && (
                            <span className="px-1.5 py-0.5 rounded text-xs font-bold bg-blue-500/20 text-blue-400 border border-blue-500/30">
                              {feature.badge}
                            </span>
                          )}
                        </div>
